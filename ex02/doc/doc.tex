...
\title{Computer Graphics I - WS12/13 \\ Excercise 2 \\ \emph{Transformationen / Kanonisches Sichtvolumen
}}
\author{\textbf{Team 6}: Eugen Torkin, Rolf Paul Schroeder, Robin Vobruba}
\date{\today}

\pdfinfo{%
  /Title    (Computer Graphics I - WS12/13 - Excercise 2 - Transformationen / Kanonisches Sichtvolumen
)
